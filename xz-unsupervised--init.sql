...
create or replace function kmeans_inference_cpu_float_pluj(Float8[],Float4[]) returns int as 'F|ai/sedn/unsupervised/Kmeans|euclidean_distance_classmembership_cpu_float|([D[[F)I' LANGUAGE ujava PARALLEL SAFE IMMUTABLE;
